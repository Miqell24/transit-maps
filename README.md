...
One-page portal for the thirteen-city transit map family. Live: **https://miqell24.github.io/transit-maps/**
...
- `tools/render-thumbs.mjs` — regenerates the thirteen SVG miniatures. Requires the sibling map
