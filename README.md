...
One-page portal for the six-city transit map family. Live: **https://miqell24.github.io/transit-maps/**
...
- `tools/render-thumbs.mjs` — regenerates the six SVG miniatures. Requires the sibling map
